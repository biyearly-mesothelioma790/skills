...
- [transcribe](./transcribe) — speech-to-text for audio and video files using pluggable ASR backends (whisper, whisperX, faster-whisper, OpenAI, Groq, Deepgram, AssemblyAI, Gemini). Handles 1-8+ hour files with silence skipping, optional speaker diarization, and custom vocabulary.
